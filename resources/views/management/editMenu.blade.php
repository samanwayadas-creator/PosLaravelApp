...
@section('content')
    ...
    <div class="col-md-8"> <i class="fas fa-pizza-slice"></i>  Edit Menu
    <hr>
    @if($errors->any())
    ...
    @method('PUT')
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" 
             value="{{$menu->name}}" placeholder="Menu items...">
        </div>
        ...
        <div class="input-group mb-3">
            ...
            value="{{$menu->price}}" aria-label="Amount (in Rupees)">
        </div>
        ...
        <div class="form-group">
         ...
         value="{{$menu->decription}}" placeholder="Add item description">
        </div>
